...
foreign import formatDateImpl :: JSDate -> String -> String -> UtilitiesUtilities.Utilities -> Effect String


-- Formats date according to specification described in Java SE SimpleDateFormat
-- class.
formatDate :: JSDate -> String -> String -> UtilitiesUtilities.Utilities -> Effect String
