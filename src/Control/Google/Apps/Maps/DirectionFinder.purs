...
foreign import setArriveImpl :: Foreign -> MapsDirectionFinder.DirectionFinder -> Effect MapsDirectionFinder.DirectionFinder


-- | Sets the desired time of arrival (when applicable).
setArrive :: Foreign -> MapsDirectionFinder.DirectionFinder -> Effect MapsDirectionFinder.DirectionFinder
...
foreign import setDepartImpl :: Foreign -> MapsDirectionFinder.DirectionFinder -> Effect MapsDirectionFinder.DirectionFinder


-- | Sets the desired time of departure (when applicable).
setDepart :: Foreign -> MapsDirectionFinder.DirectionFinder -> Effect MapsDirectionFinder.DirectionFinder
