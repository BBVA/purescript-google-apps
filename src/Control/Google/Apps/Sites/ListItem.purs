...
foreign import getDatePublishedImpl :: SitesListItem.ListItem -> Effect JSDate


-- Return the date this list item was first published.
getDatePublished :: SitesListItem.ListItem -> Effect JSDate
getDatePublished  p' =  getDatePublishedImpl  p'



foreign import getLastUpdatedImpl :: SitesListItem.ListItem -> Effect JSDate


-- Return the date this comment was last updated.
getLastUpdated :: SitesListItem.ListItem -> Effect JSDate
