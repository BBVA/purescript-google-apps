...
foreign import getDatePublishedImpl :: SitesPage.Page -> Effect Foreign


-- | Return the date this page was first published.
getDatePublished :: SitesPage.Page -> Effect Foreign
...
foreign import getLastEditedImpl :: SitesPage.Page -> Effect Foreign


-- | Return the last edit date, which includes only content edits.
getLastEdited :: SitesPage.Page -> Effect Foreign
getLastEdited  p' =  getLastEditedImpl  p'



foreign import getLastUpdatedImpl :: SitesPage.Page -> Effect Foreign


-- | Return the last updated date, which includes non-content changes like moving.
getLastUpdated :: SitesPage.Page -> Effect Foreign
