...
foreign import getDatePublishedImpl :: SitesAttachment.Attachment -> Effect JSDate


-- Return the date this attachment was first published.
getDatePublished :: SitesAttachment.Attachment -> Effect JSDate
...
foreign import getLastUpdatedImpl :: SitesAttachment.Attachment -> Effect JSDate


-- Return the date this attachment was last updated.
getLastUpdated :: SitesAttachment.Attachment -> Effect JSDate
