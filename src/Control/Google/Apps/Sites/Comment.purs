...
foreign import getDatePublishedImpl :: SitesComment.Comment -> Effect Foreign


-- | Return the date this comment was originally published.
getDatePublished :: SitesComment.Comment -> Effect Foreign
getDatePublished  p' =  getDatePublishedImpl  p'



foreign import getLastUpdatedImpl :: SitesComment.Comment -> Effect Foreign


-- | Return the date this comment was last updated.
getLastUpdated :: SitesComment.Comment -> Effect Foreign
