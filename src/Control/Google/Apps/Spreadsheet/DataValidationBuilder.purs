...
foreign import requireDateAfterImpl :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date after the given value.
requireDateAfter :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateAfter date p' =  requireDateAfterImpl date p'



foreign import requireDateBeforeImpl :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date before the given value.
requireDateBefore :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateBefore date p' =  requireDateBeforeImpl date p'



foreign import requireDateBetweenImpl :: JSDate -> JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date that falls between, or is
-- either of, two specified dates.
requireDateBetween :: JSDate -> JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateBetween start end p' =  requireDateBetweenImpl start end p'



foreign import requireDateEqualToImpl :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date equal to the given value.
requireDateEqualTo :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateEqualTo date p' =  requireDateEqualToImpl date p'



foreign import requireDateNotBetweenImpl :: JSDate -> JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date that does not fall between,
-- and is neither of, two specified dates.
requireDateNotBetween :: JSDate -> JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateNotBetween start end p' =  requireDateNotBetweenImpl start end p'



foreign import requireDateOnOrAfterImpl :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date on or after the given value.
requireDateOnOrAfter :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
requireDateOnOrAfter date p' =  requireDateOnOrAfterImpl date p'



foreign import requireDateOnOrBeforeImpl :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder


-- Sets the data validation rule to require a date on or before the given value.
requireDateOnOrBefore :: JSDate -> SpreadsheetDataValidationBuilder.DataValidationBuilder -> Effect SpreadsheetDataValidationBuilder.DataValidationBuilder
