...
foreign import whenDateAfterWithDateImpl :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder


-- Sets the conditional format rule to trigger when a date is after the given
-- value.
whenDateAfterWithDate :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder
...
foreign import whenDateBeforeWithDateImpl :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder


-- Sets the conditional format rule to trigger when a date is before the given
-- date.
whenDateBeforeWithDate :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder
...
foreign import whenDateEqualToWithDateImpl :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder


-- Sets the conditional format rule to trigger when a date is equal to the given
-- date.
whenDateEqualToWithDate :: JSDate -> SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder -> Effect SpreadsheetConditionalFormatRuleBuilder.ConditionalFormatRuleBuilder
