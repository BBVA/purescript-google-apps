...
foreign import getLastExecutionTimeImpl :: SpreadsheetDataExecutionStatus.DataExecutionStatus -> Effect JSDate


-- Gets the time the last data execution completed regardless of the execution
-- state.
getLastExecutionTime :: SpreadsheetDataExecutionStatus.DataExecutionStatus -> Effect JSDate
getLastExecutionTime  p' =  getLastExecutionTimeImpl  p'



foreign import getLastRefreshedTimeImpl :: SpreadsheetDataExecutionStatus.DataExecutionStatus -> Effect JSDate


-- Gets the time the data last successfully refreshed.
getLastRefreshedTime :: SpreadsheetDataExecutionStatus.DataExecutionStatus -> Effect JSDate
