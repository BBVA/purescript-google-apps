...
foreign import whenDateAfterWithDateImpl :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where the cell date is after the
-- | specified value.
whenDateAfterWithDate :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
...
foreign import whenDateBeforeWithDateImpl :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where the cell date is before the
-- | specified date.
whenDateBeforeWithDate :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
...
foreign import whenDateEqualToWithDateImpl :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where a cell date is equal to the
-- | specified date.
whenDateEqualToWithDate :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
...
foreign import whenDateEqualToAnyImpl :: (Array Foreign) -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where the cell date is equal to any of
-- | the specified dates.
whenDateEqualToAny :: (Array Foreign) -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
whenDateEqualToAny dates p' =  whenDateEqualToAnyImpl dates p'



foreign import whenDateNotEqualToImpl :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where the cell date is not equal to
-- | the specified date.
whenDateNotEqualTo :: Foreign -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
whenDateNotEqualTo date p' =  whenDateNotEqualToImpl date p'



foreign import whenDateNotEqualToAnyImpl :: (Array Foreign) -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder


-- | Sets the filter criteria to show cells where the cell date is not equal to
-- | any of the specified dates.
whenDateNotEqualToAny :: (Array Foreign) -> SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder -> Effect SpreadsheetFilterCriteriaBuilder.FilterCriteriaBuilder
