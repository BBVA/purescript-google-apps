...
foreign import setRowHeightsForcedImpl :: Int -> Int -> Int -> SpreadsheetSheet.Sheet -> Effect SpreadsheetSheet.Sheet


-- | Sets the height of the given rows in pixels.
setRowHeightsForced :: Int -> Int -> Int -> SpreadsheetSheet.Sheet -> Effect SpreadsheetSheet.Sheet
setRowHeightsForced startRow numRows height p' =  setRowHeightsForcedImpl startRow numRows height p'
