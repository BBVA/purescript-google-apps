...
exports.createShortcutForTargetIdAndResourceKeyImpl = (targetId) => (targetResourceKey) => (p_) => () => {
  return p_.createShortcutForTargetIdAndResourceKey(targetId, targetResourceKey);
}
...
exports.getFileByIdAndResourceKeyImpl = (id) => (resourceKey) => (p_) => () => {
  return p_.getFileByIdAndResourceKey(id, resourceKey);
}
...
exports.getFolderByIdAndResourceKeyImpl = (id) => (resourceKey) => (p_) => () => {
  return p_.getFolderByIdAndResourceKey(id, resourceKey);
}
