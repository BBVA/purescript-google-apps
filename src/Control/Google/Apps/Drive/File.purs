...
foreign import getDateCreatedImpl :: DriveFile.File -> Effect JSDate


-- Gets the date the File was created.
getDateCreated :: DriveFile.File -> Effect JSDate
...
foreign import getLastUpdatedImpl :: DriveFile.File -> Effect JSDate


-- Gets the date the File was last updated.
getLastUpdated :: DriveFile.File -> Effect JSDate
