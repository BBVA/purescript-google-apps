...
foreign import getDateCreatedImpl :: DriveFolder.Folder -> Effect JSDate


-- Gets the date the Folder was created.
getDateCreated :: DriveFolder.Folder -> Effect JSDate
...
foreign import getLastUpdatedImpl :: DriveFolder.Folder -> Effect JSDate


-- Gets the date the Folder was last updated.
getLastUpdated :: DriveFolder.Folder -> Effect JSDate
