...
exports.getNotesPageImpl = (p_) => () => {
  return p_.getNotesPage();
}
...
exports.getSlideLinkingModeImpl = (p_) => () => {
  return p_.getSlideLinkingMode();
}

exports.getSourcePresentationIdImpl = (p_) => () => {
  return p_.getSourcePresentationId();
}

exports.getSourceSlideObjectIdImpl = (p_) => () => {
  return p_.getSourceSlideObjectId();
}
...
exports.isSkippedImpl = (p_) => () => {
  return p_.isSkipped();
}

exports.moveImpl = (index) => (p_) => () => {
  return p_.move(index);
}

exports.refreshSlideImpl = (p_) => () => {
  return p_.refreshSlide();
}
...
exports.setSkippedImpl = (isSkipped) => (p_) => () => {
  return p_.setSkipped(isSkipped);
}

exports.unlinkImpl = (p_) => () => {
  return p_.unlink();
}
