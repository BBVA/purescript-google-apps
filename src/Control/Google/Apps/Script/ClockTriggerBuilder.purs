...
foreign import atImpl :: JSDate -> ScriptClockTriggerBuilder.ClockTriggerBuilder -> Effect ScriptClockTriggerBuilder.ClockTriggerBuilder


-- Specifies when the trigger runs.
at :: JSDate -> ScriptClockTriggerBuilder.ClockTriggerBuilder -> Effect ScriptClockTriggerBuilder.ClockTriggerBuilder
