...
foreign import getResponsesWithDateImpl :: Foreign -> FormsForm.Form -> Effect FormsFormResponse.FormResponse


-- | Gets an array of all of the form's responses after a given date and time.
getResponsesWithDate :: Foreign -> FormsForm.Form -> Effect FormsFormResponse.FormResponse
