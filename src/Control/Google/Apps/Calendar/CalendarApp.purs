...
foreign import createAllDayEventWithStringDateImpl :: String -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new all-day event.
createAllDayEventWithStringDate :: String -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
createAllDayEventWithStringDate title date p' =  createAllDayEventWithStringDateImpl title date p'



foreign import createAllDayEventWithStringDateDateImpl :: String -> Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new all-day event.
createAllDayEventWithStringDateDate :: String -> Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventWithStringDateDateObjectStringStringStringBooleanImpl :: String -> Foreign -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new all-day event.
createAllDayEventWithStringDateDateObjectStringStringStringBoolean :: String -> Foreign -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventWithStringDateObjectStringStringStringBooleanImpl :: String -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new all-day event.
createAllDayEventWithStringDateObjectStringStringStringBoolean :: String -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventSeriesWithStringDateEventrecurrenceImpl :: String -> Foreign -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Creates a new all-day event series.
createAllDayEventSeriesWithStringDateEventrecurrence :: String -> Foreign -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createAllDayEventSeriesWithStringDateEventrecurrenceObjectStringStringStringBooleanImpl :: String -> Foreign -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Creates a new all-day event series.
createAllDayEventSeriesWithStringDateEventrecurrenceObjectStringStringStringBoolean :: String -> Foreign -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createEventWithStringDateDateImpl :: String -> Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new event.
createEventWithStringDateDate :: String -> Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
createEventWithStringDateDate title startTime endTime p' =  createEventWithStringDateDateImpl title startTime endTime p'



foreign import createEventWithStringDateDateObjectStringStringStringBooleanImpl :: String -> Foreign -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Creates a new event.
createEventWithStringDateDateObjectStringStringStringBoolean :: String -> Foreign -> Foreign -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createEventSeriesWithStringDateDateEventrecurrenceImpl :: String -> Foreign -> Foreign -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Creates a new event series.
createEventSeriesWithStringDateDateEventrecurrence :: String -> Foreign -> Foreign -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createEventSeriesWithStringDateDateEventrecurrenceObjectStringStringStringBooleanImpl :: String -> Foreign -> Foreign -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Creates a new event series.
createEventSeriesWithStringDateDateEventrecurrenceObjectStringStringStringBoolean :: String -> Foreign -> Foreign -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import getEventsWithDateDateImpl :: Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Gets all events that occur within a given time range.
getEventsWithDateDate :: Foreign -> Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
getEventsWithDateDate startTime endTime p' =  getEventsWithDateDateImpl startTime endTime p'



foreign import getEventsWithDateDateObjectIntegerIntegerStringStringGueststatusImpl :: Foreign -> Foreign -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatusForeign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- Some type is not directly accessible in the runtime. 
-- TODO: Implement this
-- getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus :: Foreign -> Foreign -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatus -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus :: Unit
getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus = unit



foreign import getEventsForDayWithDateImpl :: Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- | Gets all events that occur on a given day.
getEventsForDayWithDate :: Foreign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
getEventsForDayWithDate date p' =  getEventsForDayWithDateImpl date p'



foreign import getEventsForDayWithDateObjectIntegerIntegerStringStringGueststatusImpl :: Foreign -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatusForeign -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent


-- Some type is not directly accessible in the runtime. 
-- TODO: Implement this
-- getEventsForDayWithDateObjectIntegerIntegerStringStringGueststatus :: Foreign -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatus -> CalendarCalendarApp.CalendarApp -> Effect CalendarCalendarEvent.CalendarEvent
