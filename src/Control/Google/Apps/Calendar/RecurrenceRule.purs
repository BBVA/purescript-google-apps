...
foreign import addDateImpl :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarEventRecurrence.EventRecurrence


-- Adds a rule that causes the event to recur on a specific date.
addDate :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarEventRecurrence.EventRecurrence
addDate date p' =  addDateImpl date p'



foreign import addDateExclusionImpl :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarEventRecurrence.EventRecurrence


-- Adds a rule that excludes an occurrence for a specific date.
addDateExclusion :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarEventRecurrence.EventRecurrence
...
foreign import untilImpl :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarRecurrenceRule.RecurrenceRule


-- Configures the rule to end on a given date (inclusive).
until :: JSDate -> CalendarRecurrenceRule.RecurrenceRule -> Effect CalendarRecurrenceRule.RecurrenceRule
