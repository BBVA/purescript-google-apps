...
foreign import getDateCreatedImpl :: CalendarCalendarEventSeries.CalendarEventSeries -> Effect Foreign


-- | Gets the date the event was created.
getDateCreated :: CalendarCalendarEventSeries.CalendarEventSeries -> Effect Foreign
...
foreign import getLastUpdatedImpl :: CalendarCalendarEventSeries.CalendarEventSeries -> Effect Foreign


-- | Gets the date the event was last updated.
getLastUpdated :: CalendarCalendarEventSeries.CalendarEventSeries -> Effect Foreign
...
foreign import setRecurrenceWithEventrecurrenceDateImpl :: CalendarEventRecurrence.EventRecurrence -> Foreign -> CalendarCalendarEventSeries.CalendarEventSeries -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Sets the recurrence rules for an all-day event series.
setRecurrenceWithEventrecurrenceDate :: CalendarEventRecurrence.EventRecurrence -> Foreign -> CalendarCalendarEventSeries.CalendarEventSeries -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import setRecurrenceWithEventrecurrenceDateDateImpl :: CalendarEventRecurrence.EventRecurrence -> Foreign -> Foreign -> CalendarCalendarEventSeries.CalendarEventSeries -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- | Sets the recurrence rules for this event series.
setRecurrenceWithEventrecurrenceDateDate :: CalendarEventRecurrence.EventRecurrence -> Foreign -> Foreign -> CalendarCalendarEventSeries.CalendarEventSeries -> Effect CalendarCalendarEventSeries.CalendarEventSeries
