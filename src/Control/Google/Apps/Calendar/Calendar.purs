...
foreign import createAllDayEventWithStringDateImpl :: String -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new all-day event.
createAllDayEventWithStringDate :: String -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
createAllDayEventWithStringDate title date p' =  createAllDayEventWithStringDateImpl title date p'



foreign import createAllDayEventWithStringDateDateImpl :: String -> JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new all-day event.
createAllDayEventWithStringDateDate :: String -> JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventWithStringDateDateObjectStringStringStringBooleanImpl :: String -> JSDate -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new all-day event.
createAllDayEventWithStringDateDateObjectStringStringStringBoolean :: String -> JSDate -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventWithStringDateObjectStringStringStringBooleanImpl :: String -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new all-day event.
createAllDayEventWithStringDateObjectStringStringStringBoolean :: String -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createAllDayEventSeriesWithStringDateEventrecurrenceImpl :: String -> JSDate -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- Creates a new all-day event series.
createAllDayEventSeriesWithStringDateEventrecurrence :: String -> JSDate -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createAllDayEventSeriesWithStringDateEventrecurrenceObjectStringStringStringBooleanImpl :: String -> JSDate -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- Creates a new all-day event series.
createAllDayEventSeriesWithStringDateEventrecurrenceObjectStringStringStringBoolean :: String -> JSDate -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createEventWithStringDateDateImpl :: String -> JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new event.
createEventWithStringDateDate :: String -> JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
createEventWithStringDateDate title startTime endTime p' =  createEventWithStringDateDateImpl title startTime endTime p'



foreign import createEventWithStringDateDateObjectStringStringStringBooleanImpl :: String -> JSDate -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Creates a new event.
createEventWithStringDateDateObjectStringStringStringBoolean :: String -> JSDate -> JSDate -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import createEventSeriesWithStringDateDateEventrecurrenceImpl :: String -> JSDate -> JSDate -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- Creates a new event series.
createEventSeriesWithStringDateDateEventrecurrence :: String -> JSDate -> JSDate -> CalendarEventRecurrence.EventRecurrence -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import createEventSeriesWithStringDateDateEventrecurrenceObjectStringStringStringBooleanImpl :: String -> JSDate -> JSDate -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries


-- Creates a new event series.
createEventSeriesWithStringDateDateEventrecurrenceObjectStringStringStringBoolean :: String -> JSDate -> JSDate -> CalendarEventRecurrence.EventRecurrence -> Foreign -> String -> String -> String -> Boolean -> CalendarCalendar.Calendar -> Effect CalendarCalendarEventSeries.CalendarEventSeries
...
foreign import getEventsWithDateDateImpl :: JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Gets all events that occur within a given time range.
getEventsWithDateDate :: JSDate -> JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
getEventsWithDateDate startTime endTime p' =  getEventsWithDateDateImpl startTime endTime p'



foreign import getEventsWithDateDateObjectIntegerIntegerStringStringGueststatusImpl :: JSDate -> JSDate -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatusForeign -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Some type is not directly accessible in the runtime. 
-- TODO: Implement this
-- getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus :: JSDate -> JSDate -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatus -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus :: Unit
getEventsWithDateDateObjectIntegerIntegerStringStringGueststatus = unit



foreign import getEventsForDayWithDateImpl :: JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Gets all events that occur on a given day.
getEventsForDayWithDate :: JSDate -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
getEventsForDayWithDate date p' =  getEventsForDayWithDateImpl date p'



foreign import getEventsForDayWithDateObjectIntegerIntegerStringStringGueststatusImpl :: JSDate -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatusForeign -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent


-- Some type is not directly accessible in the runtime. 
-- TODO: Implement this
-- getEventsForDayWithDateObjectIntegerIntegerStringStringGueststatus :: JSDate -> Foreign -> Int -> Int -> String -> String -> CalendarGuestStatus.GuestStatus -> CalendarCalendar.Calendar -> Effect CalendarCalendarEvent.CalendarEvent
