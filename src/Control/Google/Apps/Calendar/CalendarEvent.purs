...
foreign import getAllDayEndDateImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date on which this all-day calendar event ends.
getAllDayEndDate :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
getAllDayEndDate  p' =  getAllDayEndDateImpl  p'



foreign import getAllDayStartDateImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date on which this all-day calendar event begins.
getAllDayStartDate :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
...
foreign import getDateCreatedImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date the event was created.
getDateCreated :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
...
foreign import getEndTimeImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date and time at which this calendar event ends.
getEndTime :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
...
foreign import getLastUpdatedImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date the event was last updated.
getLastUpdated :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
...
foreign import getStartTimeImpl :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate


-- Gets the date and time at which this calendar event begins.
getStartTime :: CalendarCalendarEvent.CalendarEvent -> Effect JSDate
...
foreign import setAllDayDateImpl :: JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent


-- Sets the date of the event.
setAllDayDate :: JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent
setAllDayDate date p' =  setAllDayDateImpl date p'



foreign import setAllDayDatesImpl :: JSDate -> JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent


-- Sets the dates of the event.
setAllDayDates :: JSDate -> JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent
...
foreign import setTimeImpl :: JSDate -> JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent


-- Sets the dates and times for the start and end of the event.
setTime :: JSDate -> JSDate -> CalendarCalendarEvent.CalendarEvent -> Effect CalendarCalendarEvent.CalendarEvent
