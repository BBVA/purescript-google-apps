...
foreign import addDateImpl :: Foreign -> CalendarEventRecurrence.EventRecurrence -> Effect CalendarEventRecurrence.EventRecurrence


-- | Adds a rule that causes the event to recur on a specific date.
addDate :: Foreign -> CalendarEventRecurrence.EventRecurrence -> Effect CalendarEventRecurrence.EventRecurrence
addDate date p' =  addDateImpl date p'



foreign import addDateExclusionImpl :: Foreign -> CalendarEventRecurrence.EventRecurrence -> Effect CalendarEventRecurrence.EventRecurrence


-- | Adds a rule that excludes an occurrence for a specific date.
addDateExclusion :: Foreign -> CalendarEventRecurrence.EventRecurrence -> Effect CalendarEventRecurrence.EventRecurrence
